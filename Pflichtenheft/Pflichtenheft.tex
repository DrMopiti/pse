...
\begin{description}
\item[KM1010] \textbf{\gls{Schachregeln}}
\begin{itemize}
	Alle Schachregeln sollen implementiert werden.
	Das Spielende soll definiert sein.	
\end{itemize}
\item[KM1020] \textbf{Einhaltung der \gls{Schachregeln}}
\begin{itemize}
	\item Der Nutzer soll nur gültige Züge, die den \gls{Schachregeln} entprechen ausführen können.
\end{itemize}
\item[KM1030] \textbf{Spielersuche}
\begin{itemize}
	...
	\end{itemize}
\end{itemize}
\item[KM1040] Es muss ein \gls{GUI} existieren.
\item[KM1050] \textbf{\glspl{Schachfigur} bewegen}
\begin{itemize}
