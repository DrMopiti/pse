...
\begin{itemize}
	...
	Das Spielende soll definiert sein.	
\end{itemize}
...
\begin{description}
\item[KA1010] Es soll keine selbst spielende \gls{Schach-Engine} implementiert werden.
...
\item[KA1050] Es soll nicht möglich sein andere Partien einzulesen.
\item[KA1060] Es ist nicht machbar mehrere Partien gleichzeitig zu spielen.
\item[KA1070] Der Spieler ist nicht in der Lage seinem Gegener mehr Zeit zu gewähren.
\end{description}
\newpage
