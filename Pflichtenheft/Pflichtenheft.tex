...
{
	name=Schachregeln,
	description={Schachregeln die gültige Züge und das Ende des Spiels definieren. Siehe https://de.wikipedia.org/wiki/Schach#Spielregeln für mehr Informationen}
}
...
{
	name={Elo},
	description={Wertung, die die Spielstärke beschreibt. Siehe https://de.wikipedia.org/wiki/Elo-Zahl}
}
...
Nach kurzer Zeit bekommt er einen Gegner zugewiesen und die Partie beginnt. Herr Mustermann hat die Farbe Weiß zugewiesen bekommen und sein Gegner Schwarz.
