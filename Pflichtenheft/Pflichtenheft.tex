...
Es soll ein Produkt namens .... als eine App angeboten werden mit der Personen gegeneinader Schach spielen können. Spieler sollen durch eine Spierlersuche andere Gegener finden und können sich in einer Ranliste vergleichen. 
...
\begin{description}
	...
	\item[T2010] Benutzer erzeugt einen neuen Spiel \textbf{F2010}
	\item[T2020] Benutzer nimmt schon eröffnet Spiel auf \textbf{F2020}
	\item[T2030] Benutzer fordert unter Angabe eines gültigen Benutzernamens einen anderen Benutzer auf \textbf{F2030}
	\item[T2040] Benutzer nimmt die Herausforderung an \textbf{F2040}
	\item[T2050] Benutzer lehnt die Herausforderung ab \textbf{F2050}
	\item[T2060] Benutzer guckt seine Statistiken an \textbf{F2060}
	\item[T2070] Benutzer sendet eine Freundschaftsanfrage \textbf{F2070}
	\item[T2080] Benutzer akzeptiert die Freundschaftsanfrage \textbf{F2080}
	\item[T2090] Benutzer lehnt die Freundschaftsanfrage ab \textbf{F2090}
	\item[T3010] Benutzer macht irgendeinen Zug seiner Wahl, wobei die Schachregeln beibehalten werden müssen \textbf{F3010}
	\item[T3020] Benutzer bietet einen Remis an, vorausgesetzt er am Zug ist \textbf{F3020}
	\item[T3030] Benutzer akzeptiert Remis \textbf{F3030}
	\item[T3040] Benutzer lehnt Remis ab \textbf{F3040}
	\item[T3050] Benutzer tauschen Nachrichten aus \textbf{F3050}
...
\begin{enumerate}
	...
	\begin{description}
	\item[Zustand:] Remis wurde angeboten.
	\item[Aktion:] Der Spieler klickt auf den Button "Ablehnen".
