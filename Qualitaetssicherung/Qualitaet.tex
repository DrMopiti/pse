...
\begin{document}
	\begin{titlepage}
		...
		\vspace{2cm}
		{\LARGE Daniel Helmig, Tim Groß}\par		
		\newpage	
		\tableofcontents
		\pagebreak
...
\begin{description}
	...
	\begin{itemize}
		\item Schachregeln sind implementiert mit Ausnahme eines Unentschiedens aufgrund von Materialmangels.
...
\begin{description}
	...
	\item \textbf{Ergebnis: } Es können nur den Regeln entsprechende Züge ausgeführt werden.
	...
	\item \textbf{Ergebnis: } Es ist möglich ein Remis anzubieten.
	...
	\item \textbf{Ergebnis: } Es ist möglich ein Remis anzunehmen.
	...
	\item \textbf{Ergebnis: } Es ist möglich aufzugeben.
...
\begin{description}
	...
	\begin{description}
	\item Wie gewünscht implementiert. Der Gegner erhält nach Aktualisieren ein Dialogfenster.
	\end{description}
	...
	\begin{description}
	\item Wie gewünscht implementiert. Bei Ablehnen wird das Fenster geschlossen und das Spiel läuft weiter.
	\end{description}
	
	\item[T3050] \textbf{\textit{Aufgeben: }} 
	\begin{description}
	\item Wie gewünscht implementiert, das Spiel wird sofort beendet und der Gegner erhält nach aktualisieren eine Benachrichtigung.
	\end{description}
