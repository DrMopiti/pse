...
\begin{document}
	...
	\begin{itemize}
			...
			\\			
				\textbf{\large{Gemeinsame Methoden}}
				\newline
				\rule{\textwidth}{1pt}
				\begin{description}			
		...
		\begin{description}		
			...
			\\			
				...
				\begin{itemize}					
					...
					\begin{description}					
					\item \textbf{- accepted(): void}\\ 
					\item \textbf{- declined(): void}\\				
					\end{description}
					...
					\begin{description}					
					\item \textbf{- confirmed(): void}\\ 
					\item \textbf{- aborted(): void}\\					
					\end{description}
					...
					\begin{description}					
					\item \textbf{- backToMenu(): void}\\
					\item \textbf{- saveGame(): void}\\
					\item \textbf{- rematch(): void}\\					
					\end{description}
					...
					\begin{description}					
					\item \textbf{- queenSelected(): void}\\
					\item \textbf{- rookSelected(): void}\\
					\item \textbf{- bishopSelected(): void}\\
					\item \textbf{- knightSelected(): void}\\				
					\end{description}	
