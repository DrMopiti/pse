...
\newpage
		...
		\end{minipage}
		\begin{itemize}		
			\item \textbf{\Large{android.support.v7.app.AppCompactActivity}}
			
			Die AppCompactActivity wird als Dialog verwendet.\\
