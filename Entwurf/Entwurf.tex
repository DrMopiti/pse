		...
		\begin{itemize}
			...
			\\			
				...
				\begin{description}			
					...
					Fragt einen Spieler, ob er das Remis-Angebot des Gegners annemhen oder ablehnen will, dazu stehen ihm zwei Buttons zur Verfügung.\\
					
					\item \textbf{\Large{GiveUpDialog}}
					
					Ein Dialog, welcher den Spieler bestätigen lässt, dass er aufgeben will.\\
					...
					Zeigt das Ergebnis eines Spiels für beide Spieler an, und bietet ihnen die Möglichkeit zur Revanche.\\
					
					\item \textbf{\Large{PawnTransformationDialog}}
					
					Ein Dialog zur Auswahl einer Figur, in welche sich ein Bauer verwandeln soll, wenn dieser die gegnerische Grundreihe erreicht hat.\\
				...
				\begin{description}		
					...
					Hier wird ein Unentschieden-Fenster geöffnet mit den Buttons „Ja“ und „ Nein“.
					...
					Hier wird ein Aufgeben-Fenster geöffnet mit den Buttons „Ja“ und „ Nein“.
					...
					Hier wird ein Login-Menü-Fenster geöffnet. 
					...
					Hier wird ein Gewonnen-Fenster geöffnet mit den Buttons „Menü“, „Speichern“ und „Noch ein Spiel?“
					...
					Hier wird ein Bauernumwandlungs-Fenster geöffnet mit den Buttons „Queen“, „Rook“, „Bishop“ und „Knight“.
