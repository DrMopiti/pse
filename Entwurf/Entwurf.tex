...
Dort kann der Benutzer seine Statistik und den Ranglistenplatz einsehen. \\
		...
		\begin{itemize}
			...
			\\			
				...
				\begin{description}			
					...
					Es werden alle Ranglisten und Statistiken-Aktivitäten angezeigt, wie z.B. ein Rangliste mit allen Spielern und den jeweiligen Punkten oder eine Statistik über den Benutzer angezeigt.\\
	...
	\begin{minipage}{\linewidth}
		\centering
		\includegraphics[width=1\linewidth]{Diagramme/Sequenzdiagramm1}
		\captionof{figure}{Sequenzdiagramm 1}
		\label{fig:sequenzdiagramm1}
	\end{minipage}
\begin{minipage}{\linewidth}
	\centering
	\includegraphics[width=1\linewidth]{Diagramme/Sequenzdiagramm2}
