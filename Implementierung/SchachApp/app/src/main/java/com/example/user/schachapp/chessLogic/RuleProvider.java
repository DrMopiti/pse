...
/**
 * An interface which determines what methods a RuleProvider should implement
 */
public interface RuleProvider {
    ...
    /**
     * Should return all legal moves for a piece at a given position on a given board
    ...
    /**
     * Should check if the given game has ended.
